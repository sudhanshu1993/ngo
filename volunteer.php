...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/our team2.css">
        <link href="css/our motivation.css" rel="stylesheet" type="text/css">
        <link rel="stylesheet" href="css/supporting Partners.css">
...
.logoTitle{
  background-color:rgb(59, 176, 179);
 /* background-color:rgba(25, 82, 152, 0.84);*/
...
#mission{
    ...
    height:100%;
    border-radius:5px;
    background-image:url("img/img2d.jpg");
    background-size:cover;


}
#mission .fontText{
color: rgb(57, 202, 238);
font-size:60px;
...
<body>
    <?php
        if (isset($_POST['join'])) {
            ...
            $query = "select * from volunteer where email='" . $_POST['email'] . "'";
            $result = mysqli_query($con, $query);
            $num = mysqli_num_rows($result);
            $data = mysqli_fetch_assoc($result);
            if ($num > 0) {
                echo("<script>alert('Your already a member, " . $_POST['first'] . " " . $_POST['last'] . "')</script>");
                echo("<script>window.location = 'volunteer.php';</script>");
            } else {
                $query2 = "insert into volunteer(first_name,last_name,email,gender,phone,address,country,state,pincode,adhaar) values('" . $_POST['first'] . "','" . $_POST['last'] . "','" . $_POST['email'] . "','".$_POST['gender']."','" . $_POST['phone'] . "','" . $_POST['add'] . "','" . $_POST['country'] . "','" . $_POST['state'] . "','" . $_POST['pincode'] . "','" . $_POST['adhaar'] . "')";
                $result2 = mysqli_query($con, $query2);
                if ($result2) {
                    echo ("<script>alert('Congratulation you are now a member, " . $_POST['first'] . " " . $_POST['last'] . "')</script>");
...
<script src="https://code.jquery.com/jquery-2.1.4.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
       <nav>
        ...
        <div class="container" style="border: outset; margin-top: 5%; height: 160%;">
            <form action="volunteer.php" method="post">
                <div class="form-group">
                    <h2 style="position: relative;margin-left: 30%; ">Connect with us-Volunteer</h2>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail" name="last">
                        </div>
                        <div class="form-group">
                ...
                <div class="custom-control custom-radio" style="margin-bottom: 2%; margin-top: 2%;">
                        <label for="exampleInputPassword1">gender: </label>&ensp;
                        <input type="radio" id="customRadio1" name="gender" value="male" class="custom-control-input">
                        <label class="custom-control-label" for="customRadio1">Male</label>
                        <input type="radio" id="customRadio1" name="gender" value="female" class="custom-control-input">
                        <label class="custom-control-label" for="customRadio1">Female</label>
                        <input type="radio" id="customRadio1" name="gender" value="other" class="custom-control-input">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" name="add">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" name="adhaar" required="required">
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="defaultCheck1" name="accept" onchange="document.getElementById('send').disabled = !this.checked;">
                            <label class="form-check-label" for="defaultCheck1">
                                I would hereby like to declare that
                                the information provided  is to the best of knowledge
                            </label>
                        </div>

                <button type="submit" class="btn btn-primary" name="join" id="send" disabled="disabled" style="margin-top: 10%; margin-bottom: 5%;">Join</button>
                        <button type="reset" class="btn btn-primary" style="margin-top: 10%; margin-bottom: 5%;">Reset</button>
                        </form>
                </div>
