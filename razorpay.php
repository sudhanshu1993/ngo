...
<body>
     <?php
       ...
       <?php
        if (isset($_POST['send'])) {
             require 'connection.php';
            $query = "insert into donate(first_name,last_name,email,gender,phone,address,country,state,pincode,adhaar,pan) values('" . $_POST['first'] . "','" . $_POST['last'] . "','" . $_POST['email'] . "','".$_POST['gender']."','" . $_POST['phone'] . "','" . $_POST['add'] . "','" . $_POST['country'] . "','" . $_POST['state'] . "','" . $_POST['pincode'] . "','".$_POST['adhaar']."','".$_POST['pan']."')";
       ...
       <?php
        if (isset($_POST['sponsor'])) {
            ...
            require 'connection.php';
                 ...
                 $query = "insert into sponsor(email,name,gender,contact,location,occupation,kids,duration,adhaar,pan) values('" . $_POST['email'] . "','" . $_POST['first'] . "','" . $_POST['gender'] . "','" . $_POST['phone'] . "','" . $_POST['location'] . "','" . $_POST['occupationother'] . "','" . $_POST['kids'] . "','" . $_POST['duration'] . "','" . $_POST['adhaar'] . "','" . $_POST['pan'] . "')";
            $result = mysqli_query($con, $query);
...
<script src="https://code.jquery.com/jquery-2.1.4.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
       <nav>
         ...
         <form action="index.php" method="POST">
                 <h2>Reciet</h2>
                 <table border='5' style="margin-left: 30%; margin-bottom: 5%; width: 40%; font-size: 140%; height: 40%;">
                 <tr>
                     <td><b>Name</b></td>
                 <td style="margin-left: 80%;"><?php echo $_POST['first']; ?></td>
                 </tr>
                 <tr>
    ...
    data-key="rzp_test_Rh7ft8ij9EyEyE" // Enter the Key ID generated from the Dashboard
    data-amount="<?php echo $amt; ?>" // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
    data-buttontext="Pay with Razorpay"
    data-name="<?php echo $_POST['first']; ?>"
    data-description=""
    data-image=""
    data-prefill.name=""
