...
<body onload="myfunction()">
    ...
    <div id="popUpMain_2" style="display:none">
        <div id="popUp_2">
            <center><h1 id="title">LOGIN HERE!!</h1>
                ...
                <font size="5" color="white">Contact:</font>&nbsp;<input type="text" placeholder="Enter number or email" id="contact2" value="aa"><br>
                <br>
    ...
    <div class="header" id="myheader">
      ...
      <li class="make_pay"><a class="active"  href="#popUpMain" ><strong>Make Payment</strong></a>
        ...
        <br><br><div id="message2" class="container-fluid city">
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                ...
                <div class="motivation-item" >
                    <center>
                        ...
                        <div class="motivation-content1"><br>
                            <p>Every child is an artist.They have the potential to bring</p>
                            <p>incredible to our world.But first, we need to recognise their</p>
                            <p>value.These  about children encourage us to give them our</p>
                            <p>loving care and support.Children are more than we think they</p>
                            <p>are; they can do more than we think they can do. All they</p>
                            <p>need is a vote of confidence from grownups.Their dream </p>
                            <p>today will become the realities of tomorrow.</p>
                        </div>
                    </center>
                </div>
                <div class="motivation-item">
