...
<body>
      ...
      if(isset($_POST['upload'])){
          ...
          $target2=$_FILES['image2']['name'];
          $target3=$_FILES['image3']['name'];
          session_start();
          require 'connection.php';
          $image=$_FILES['image']['name'];
          $image2=$_FILES['image2']['name'];
          $image3=$_FILES['image3']['name'];
          $query="insert into sreg(name,pname,email,gender,phone,insti,doc,adhaar,school,photo) values('".$_POST['name']."','".$_POST['pname']."','".$_POST['email']."','".$_POST['gender']."','".$_POST['phone']."','".$_POST['insti']."','$image','".$_POST['adhaar']."','$image2','$image3')";
       ...
       <nav>
        ...
        <div class="container" style="border: outset; margin-top: 5%; height: 130%; margin-bottom: 5%;">
            <form action="student_register.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group" id="name_insti">
