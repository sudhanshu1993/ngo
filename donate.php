...
<script src="https://code.jquery.com/jquery-2.1.4.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
      ...
      <li class="make_pay"><a href="#popUpMain" ><strong>Make Payment</strong></a>
        ...
        <div class="container" style="border: outset; margin-top: 5%; height: 180%; margin-bottom: 5%;">
            <form action="razorpay.php" method="post">

                <div class="form-group">
                    <h2>Please provide your valuable contribution by filing in the details below</h2>
                ...
                <div class="form-group" id="country">
                  ...
                  <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary" name="send">Donate Now</button>
